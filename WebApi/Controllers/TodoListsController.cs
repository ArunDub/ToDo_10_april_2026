...
namespace WebApi.Controllers
{
    ...
    public class TodoListsController : ControllerBase
    {
        ...
        {
            var modelvms = await _service.TodoListService.Get();
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            var modelDto = await _service.TodoListService.Get(id);
            if (modelDto == null)
        ...
        public async Task<IActionResult> Create([FromBody] TodoListDto modelDto)
        {
            ...
            var createdDto = await _service.TodoListService.Create(modelDto);
            if (createdDto == null)
        ...
        public async Task<IActionResult> Update(int id, [FromBody] TodoListDto modelDto)
        {
            ...
            var updatedDto = await _service.TodoListService.Update(modelDto);
            if (updatedDto == null)
            {
        ...
        public async Task <IActionResult>Delete(int id)
        {
            ...
            var rowsAffected = await _service.TodoListService.Delete(id);
            if(rowsAffected<=0)
            {
        ...
        public async Task<IActionResult> CreatRange([FromBody] List<TodoListDto> modelDto)
        {
            if (modelDto == null)
            ...
            var createdDtos = await _service.TodoListService.CreateRange(modelDto);
        ...
        public async Task<IActionResult> UpdateRange([FromBody] List<TodoListDto> modelDtos)
        {
            ...
            var updatedDto = await _service.TodoListService.UpdateRange(modelDtos);
        ...
        public async Task<IActionResult> DeleteRange([FromBody] List<TodoListDto> modelDtos)
        {
            if (modelDtos == null || modelDtos.Count <= 0)
            {
            ...
            var rowsAffected = await _service.TodoListService.DeleteRange(modelDtos);
            if (rowsAffected <= 0)
            {
